...
export function SignupForm({ className, ...props }: React.ComponentProps<"div">) {
    ...
    return (
        <div className={cn("flex flex-col gap-6", className)} {...props}>
            <Card className="overflow-hidden bg-gradient-to-l from-card to-input">
                    ...
                    <form className="p-6 md:p-8" onSubmit={handleSignUp}>
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="grid gap-2">
                                <Label htmlFor="name" className="text-foreground">{t("Auth.signUp.username")}</Label>
                                <Input
                                    id="name"
                                    type="text"
                            ...
                            <div className="grid gap-3">
                                ...
                                <Input
                                    ...
                                    required
                                />
                                <PasswordStrengthMeter password={password} strength={0} />
                            </div>
                ...
                <span className="relative z-10 bg-gradient-to-l from-card to-input px-2 text-muted-foreground">
                  {t("Auth.signUp.or")}
                </span>
              </div>
              <div className="grid grid-cols-3 gap-4">
                <Button variant="outline" className="w-full bg-gradient-to-tr from-card to-input">
                ...
                <Button variant="outline" className="w-full bg-gradient-to-br from-card to-input">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5">
                    <path
                ...
                <Button variant="outline" className="w-full bg-gradient-to-tl from-card to-input">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5">
                    <path
      ...
      <div className="text-balance text-center text-xs text-muted-foreground [&_a]:underline [&_a]:underline-offset-4 hover:[&_a]:text-primary">
        ...
        and 
        <Link to="/privacy"> {t("Auth.signUp.privacyPolicy")} </Link>.
      </div>
        </div>
    );
}
